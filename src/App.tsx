const App = () => {
  ...
  return (
    <main className="flex h-screen items-center justify-center">
      <div className="space-y-6 rounded-xl border border-gray-400 p-8">
        <div className="flex gap-x-8">
          <div className="flex flex-col gap-y-6">
            ...
            <div className="flex flex-col items-center gap-y-4">
              <button className="w-full">Check payment</button>
          ...
          <div className="flex w-72 flex-col">
            ...
            <div className="mb-2 rounded-2xl bg-gray-200 py-4">
              <p className="text-center text-2xl font-semibold">[remaining time]</p>
            </div>
            ...
            <div className="flex grow flex-col gap-y-3 rounded-2xl bg-gray-200 p-4">
              ...
              <p className="leading-tight">
                3. A partially paid transfer will not be credited to the account. Please
                indicate the exact amount when transferring.
              </p>
